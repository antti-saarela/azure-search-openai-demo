...
AZURE_OPENAI_SERVICE = os.getenv("AZURE_OPENAI_SERVICE", "asa-openai-eus")
AZURE_OPENAI_GPT_DEPLOYMENT = os.getenv("AZURE_OPENAI_GPT_DEPLOYMENT", "asa-gpt-4-32k")
AZURE_OPENAI_CHATGPT_DEPLOYMENT = os.getenv("AZURE_OPENAI_CHATGPT_DEPLOYMENT", "asa-gpt-4-32k")
AZURE_OPENAI_CHATGPT_MODEL = os.getenv("AZURE_OPENAI_CHATGPT_MODEL", "gpt-4-32k")
